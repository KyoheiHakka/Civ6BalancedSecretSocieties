...
-- アピールが最大のパネルの全出力が+1
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
    ('MODIFIER_KH_BREATHTAKING_PLOT_SCIENCE_HERMETIC_3', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'PLOT_BREATHTAKING_APPEAL'),
    ('MODIFIER_KH_BREATHTAKING_PLOT_CULTURE_HERMETIC_3', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'PLOT_BREATHTAKING_APPEAL'),
    ('MODIFIER_KH_BREATHTAKING_PLOT_GOLD_HERMETIC_3', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'PLOT_BREATHTAKING_APPEAL'),
    -- ('MODIFIER_KH_BREATHTAKING_PLOT_PRODUCTION_HERMETIC_3', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'PLOT_BREATHTAKING_APPEAL'),
    ('MODIFIER_KH_BREATHTAKING_PLOT_FAITH_HERMETIC_3', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'PLOT_BREATHTAKING_APPEAL');
    -- ('MODIFIER_KH_BREATHTAKING_PLOT_FOOD_HERMETIC_3', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'PLOT_BREATHTAKING_APPEAL');
