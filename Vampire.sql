...
WHERE 
	ModifierId = 'SECRET_SOCIETIES_ATTACH_PLAYER_CASTLES_TELEPORT' AND
...
DELETE FROM GovernorPromotionModifiers 
WHERE 
	ModifierId = 'SECRET_SOCIETY_GRANT_VAMPIRE' AND
...
INSERT INTO Modifiers (ModifierId, ModifierType) VALUES
    ('MODIFIER_KH_SANGUINE_MOVEMENT_BONUS', 'MODIFIER_PLAYER_UNITS_ATTACH_MODIFIER');
INSERT INTO Modifiers (ModifierId, ModifierType) VALUES
...
DELETE FROM GovernorPromotionModifiers 
WHERE 
	ModifierId = 'SECRET_SOCIETY_GRANT_ONE_VAMPIRE_BUILD' AND
	GovernorPromotionType = 'GOVERNOR_PROMOTION_SANGUINE_PACT_3';	

-- バンパイアは捕獲能力を得る
INSERT OR IGNORE INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
('REQUIRE_THIS_UNIT_IS_A_VAMPIRE_SETS', 'REQUIREMENTSET_TEST_ALL');

INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
('REQUIRE_THIS_UNIT_IS_A_VAMPIRE_SETS', 'REQUIRE_THIS_UNIT_IS_A_VAMPIRE');

INSERT OR IGNORE INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES 
('MODIFIER_KH_VAMPIRE_CAPTURE_UNITS', 'MODIFIER_PLAYER_UNITS_ATTACH_MODIFIER', 'REQUIRE_THIS_UNIT_IS_A_VAMPIRE_SETS');
